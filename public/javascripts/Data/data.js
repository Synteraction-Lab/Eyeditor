export const data = {
    ...
    'study': {
        't1': {
            ...
            'path_medi': {
                'task_easy': 'Phil and but Leon went to visiting the lake. _ were going phishing that evening. The the two started set up the rods. Sudden there was aloud splash. Both off them looked up to checked. Some thin strange was move in the water. The to boys noticed a hand waving _ them. Sum one had fall in the water.',
                ...
                'task_hard': 'A dynasties is is a line off off emperors. The the Ming dynamite ruling China Chinese from from 1368 to 1644. The die nasties that came before and after the Ming where off foreign origin. The Ming emperors, having rid they are county of the Mongols, do knot welcome other foreigners. They fear fear that China might lost it wealth and identity to outsiders. Foreign influences, such as Christianity, are supress and Chinese are and literate flourished. Ming paint painter developed a lively and vivid style _ art art. The Ming die nasty later fell two invade from Manchuria.',
            },
            ...
            'path_hard': {
                ...
                'task_hard': 'The chameleon is a strange look rip tile that can change its color _ suitcase its surroundings. Its its can blending on with its background remarkably well. It is enables it to approach its food quite closely without be noticing. All so interest is how chameleons can move their eyes independence of _ other. One one eyes can be searching for food while the another looking out for danger. How it catch it has prey is equal fascinate. If a camel spot an insect, _ sneaks inn closer. Then, the tongue the shoot out, and the insect makes for an the scrumptious meal.',
            },
        },

        't2': {
            'path_easy': {
                'task_easy': 'Nichole she spends her summers on the countryside. Herself cousin, Macy, are a great company. The too always have fun to gather. Most _ their time is spending outdoors. Bath of them love climbs trees. Their pick fruits _ flowers. The girl are always tired by the beginning of the day. _ usually fall asleep while watch the TV.',
                ...
                'task_hard': 'The the University is made up of thousands of millions of galaxy galaxy and vast empty spaces. No no oneself knows the size of the a Universal. It has it is estimated to have a radius of ten thousand millionaire light ears. This might not _ correction since it could continue infinite inside all directions. However, us does know that the galaxies are move way from each other at great speeds. Hence, a University is expanding null the times. Scientist believes that the Universe has been expanding since the time its has formed. _ Universal is almost fourteen bill ears old.',
            },

            'path_medi': {
                'task_easy': 'The Moon moon is the satellite of the Sun. The boon orbits the Earth on a month. The atom sphere is devoid of hair. Consequently, not life exists _ it. Animal beings have ventured _ the moon. They have lunched satellites to take picture. Also, rovers rovers scout the sir face. Scientific strives to learn less about the moon.',
            ...
            'path_hard': {
                ...
                'task_hard': 'All tax fax machinery share a commons work principle. When the the fox machine receives a signal, it is fed up into a printers. The signal tell tales where the light and dark spots are location _ the original document. _ print printer then recreates the document in horizon tall chains of dots. Both a sender _ receiver need a fox _. The send feed in the document and dials _ fox machine. Once the connection _ make, a light-sensitive device scan each pages. The scan the scan creates an electric signal correspondence two the light and dark spots on the page.',
            },
        }
    }
}